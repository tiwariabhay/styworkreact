...
const Viewquery = () => {
    ...
    const LockData = async (id) => {
        ...
        console.log(post);
        const response = await axios.post("http://184.168.30.68:5000/Agentlockquery", post);
        console.log(response.data);
                            ...
                            {queryList.length > 0 && (
                                queryList.map(queryitems => (
                                    <tr>
                                        ...
                                        <td>{(queryitems.status>=4)?(<span>Locked query</span>)
                                        :(<Link id={queryitems.id} name={queryitems.id}
                                            ...
                                            to={'/viewquery'}>Lock</Link>)}
                                             ...
                                             className='btn btn-primary'>
                                                Trasfer</NavLink>
                                            <Link to={"/agentOnQuery/"+queryitems.id+"/"+userid}
